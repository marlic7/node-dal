...
var _              = require('underscore-mixins2'),
    ...
    requiredVer    = '~1.4.0'; // oracledb@1.1.0 >= requiredVer < oracledb@1.2.0
...
function OracleDB(driver, cfg) {
    ...
    //noinspection JSUnusedAssignment,JSUnresolvedFunction
 ...
 */
OracleDB.prototype.runProcedure = function(procName, bind, opt, cb) {
...
function getFetchDbmsOutputLineFn (dal) {
    var fetchDbmsOutputLine = function (conn, results, dbmsOutput, cb) {
