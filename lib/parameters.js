...
const lib = {
    ...
    /**
     * @param args 'tbl:string, data:object, sequence:string, [cb:function]'
     * @returns {*}
     */
    ...
    /**
     * @param args 'sql:string, bind:object|Array, sequence:string, [cb:function]'
     * @returns {*}
     */
